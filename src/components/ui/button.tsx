  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        game: "bg-gradient-to-b from-primary/25 to-primary/10 border border-primary/50 text-foreground hover:scale-105 hover:-translate-y-0.5 active:scale-95 active:translate-y-0 backdrop-blur-sm",
        camp: "bg-gradient-to-b from-primary/25 to-primary/10 border border-primary/50 text-foreground hover:bg-primary/20 backdrop-blur-sm",
      },
      size: {
